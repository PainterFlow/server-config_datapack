...
execute if score @s input matches 1 run data modify entity @s data.render_data.notifications.settings.queue set value "blobs.dialogs.inputs.hide"
execute if score @s input matches 0 run data modify entity @s data.render_data.notifications.settings.queue set value "blobs.dialogs.inputs.show"

scoreboard players reset @s input

function blobs:settings/user_settings/notifications/modules/queue
