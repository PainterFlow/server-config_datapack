...
execute if score @s input matches 1 run data modify entity @s data.render_data.accessibility.settings.tower_reset_timer set value "blobs.dialogs.inputs.hide"
execute if score @s input matches 0 run data modify entity @s data.render_data.accessibility.settings.tower_reset_timer set value "blobs.dialogs.inputs.show"
