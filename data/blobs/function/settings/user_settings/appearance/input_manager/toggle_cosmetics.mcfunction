...
execute if data entity @s data.settings.appearance{toggle_cosmetics:1b} run scoreboard players set @s input 1
execute if data entity @s data.settings.appearance{toggle_cosmetics:0b} run scoreboard players set @s input 0
