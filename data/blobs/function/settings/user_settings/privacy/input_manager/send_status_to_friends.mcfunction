...
execute if score @s input matches 1 run data modify entity @s data.render_data.privacy.settings.send_status_to_friends set value "blobs.dialogs.inputs.false"
execute if score @s input matches 0 run data modify entity @s data.render_data.privacy.settings.send_status_to_friends set value "blobs.dialogs.inputs.true"
