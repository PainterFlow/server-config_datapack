...
execute if data entity @s data.settings.privacy{friend_requests:1b} run scoreboard players set @s input 1
execute if data entity @s data.settings.privacy{friend_requests:0b} run scoreboard players set @s input 0
...
function blobs:settings/user_settings/privacy/modules/friend_requests
