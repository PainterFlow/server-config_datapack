execute unless entity @e[type=#minecraft:arrows,limit=500] run kill @e[type=#minecraft:arrows]
execute unless entity @e[type=item,limit=500] run kill @e[type=item]
