...
tellraw @a[tag=debugParsingThread] {text:"[BLOBS-PARSING] ",color:"dark_purple",bold:1b,extra:[{text:"Updated User Settings",color:"gray",italic:1b,bold:0b}]}
...
execute as @s if score @s blob matches 1004 run function blobs:settings/_beta