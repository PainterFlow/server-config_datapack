...
execute store result entity @s equipment.saddle.components."minecraft:custom_data".blob.unique_id.id double 1 run scoreboard players operation @s unique_id = .Global unique_id
scoreboard players add .Global unique_id 1

execute store result entity @s equipment.saddle.components."minecraft:custom_data".unique_id.id double 1 run scoreboard players operation @s unique_id = .Global unique_id
